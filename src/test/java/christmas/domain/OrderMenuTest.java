...
public class OrderMenuTest {
    ...
    @Test
    void validOrderMenu() {
        assertDoesNotThrow(() -> new OrderMenu("양송이수프"));
        assertDoesNotThrow(() -> new OrderMenu("티본스테이크"));
    }
    ...
    void checkOrderMenuPrice() {
        OrderMenu orderSoup = new OrderMenu("양송이수프");
        assertEquals(6_000, orderSoup.getPrice());

        OrderMenu orderSteak = new OrderMenu("티본스테이크");
