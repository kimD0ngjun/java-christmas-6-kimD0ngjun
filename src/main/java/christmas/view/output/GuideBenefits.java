...
public class GuideBenefits {
    ...
    public GuideBenefits(TotalPrice totalPrice, OrderList orderList, OrderDate orderDate) {
    ...
    private void guideXMasDiscount(OrderList orderList, OrderDate orderDate, XMasDiscount xMasDiscount) {
    ...
    private void guideWeekDiscount(OrderList orderList, OrderDate orderDate, WeekDiscount weekDiscount) {
    ...
    private void guideSpecialDiscount(OrderList orderList, OrderDate orderDate, SpecialDiscount specialDiscount) {
    ...
    private void guidePresentDiscount(TotalPrice totalPrice, OrderList orderList) {
        int totalAmount = totalPrice.calculateTotalPrice(orderList);
